        ...
        {!whatsappDismissed && (
          <div className="group relative mr-2 hidden shrink-0 @[40rem]:block">
            <a
              ...
              className="flex cursor-pointer select-none items-center gap-1 whitespace-nowrap rounded-md border border-edge px-2 py-1 text-xs text-fg-muted transition-colors hover:bg-surface-hover hover:text-fg-strong"
            >
